...
"');
    ...
    rs.forEach(function(r){
        ...
        if(a){
            var id=a.getAttribute('onmousedown').match(/\d+/)[0];
    ...
    if(cnt==0)return alert('لا يوجد مواد');
    ...
    btn.onclick=function(){
        ...
        if(q.length==0)return alert('اختر مادة!');
        run=true;
        btn.disabled=true;
    ...
    setInterval(function(){
        ...
        try{
            ...
            var bGen=fd.querySelector('a.btn');
            
            if(suc||(step=='B'&&(b3||b2||(bGen&&bGen.innerText.includes('رجوع'))))){
            ...
            if(fd.querySelector('table.rowFlow')){
                ...
                if(step=='L'){
                    if(q.length==0){
                        ...
                        alert('تم الانتهاء من جميع المواد!');
                        d.location.reload();
                        return
                    }
                ...
                if(step=='W'){
                    ...
                    trs.forEach(function(r){
                        ...
                        if(i.length>2){
                            if(r.innerText.includes('ظلل')||r.innerText.includes('تأكد')){
                                i[2].checked=true;
                                trick++
                            }else{
